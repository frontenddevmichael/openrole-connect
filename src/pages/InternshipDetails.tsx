...
export default function InternshipDetails() {
  ...
  const toggleSave = async () => {
    ...
    if (isSaved) {
      ...
      await supabase
        .from('saved_internships')
        .insert({ internship_id: internship.id, student_id: user.id });
      setIsSaved(true);
  ...
  const deadlinePassed = internship.application_deadline 
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="card-elevated p-8 animate-slide-up">
              ...
              {/* Details grid */}
              <div className="grid sm:grid-cols-2 gap-4 p-4 bg-surface-sunken rounded-lg mb-8">
                {internship.location && (
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  {internship.profiles?.organization_website && (
                    <a 
                      href={internship.profiles.organization_website}
                      target="_blank"
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              ...
              <Textarea
                id="coverLetter"
                placeholder="Tell the organization why you're interested in this role..."
                value={coverLetter}
